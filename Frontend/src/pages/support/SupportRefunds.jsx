    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-slate-200 bg-white px-6 py-14 text-center">
          <span className="flex size-14 items-center justify-center rounded-2xl bg-cyan-50 text-cyan-600"><Banknote className="size-6" /></span>
          <h2 className="text-base font-semibold">No refund requests here</h2>
          <p className="max-w-sm text-sm text-slate-500">Refund queries raised by customers will appear here.</p>
        </div>
      )}
    </div>
  )
