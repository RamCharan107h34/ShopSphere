...
import { Bike, ClipboardList, LayoutDashboard, LogOut, UserRound } from 'lucide-react'
  ...
  if (user.role !== 'delivery') {
    return (
      <div className="mx-auto flex min-h-[60vh] max-w-xl flex-col items-center justify-center px-4 py-16 text-center">
        ...
        <h1 className="mt-5 text-2xl font-bold tracking-tight">Delivery dashboard</h1>
        <p className="mt-2 text-muted-foreground">
          Your account is a <span className="font-medium capitalize text-foreground">{user.role}</span>. Only delivery
          partners can access this dashboard.
        </p>
